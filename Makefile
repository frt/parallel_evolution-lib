...
OBJ_FILES = $(BUILD_DIR)/migrant.o $(BUILD_DIR)/topology.o $(BUILD_DIR)/algorithm.o $(BUILD_DIR)/topology_parser.o $(BUILD_DIR)/population.o
...
$(BUILD_DIR)/population.o: $(SRC_DIR)/population.c $(INCLUDE_DIR)/population.h $(INCLUDE_DIR)/common.h $(INCLUDE_DIR)/migrant.h
	$(CC) $(CFLAGS) -c -o $@ $<
